    ...
    <div className="row mt-5 mt-lg-0 text-capitalize text-center align-items-center">
      ...
      <div className="col-10 mx-auto col-lg-2 my-2 my-lg-0">
        <div className="d-flex justify-content-center">
          <div><FaChevronCircleDown className="cart-icon text-primary" onClick={() => decrement(id)}/></div>

          <div className="text-title text-muted mx-3">{count}</div>

          <div><FaChevronCircleUp className="cart-icon text-primary" onClick={() => increment(id)}/></div>
        </div>
      </div>
